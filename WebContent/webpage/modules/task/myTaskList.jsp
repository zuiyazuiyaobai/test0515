            ...
            <div class="row">
                <div class="col-sm-12">
                    <form:form id="searchForm" modelAttribute="xmjbxxTaskRelationSearchParameter"
                               action="${ctx}/task/cInsBusinessXmjbxxTaskRelation/myTaskList" method="post" class="form-inline">
                ...
                <div class="col-sm-12">
                    <div class="pull-left">
                       <!--  <button class="btn btn-white btn-sm" data-toggle="tooltip" data-placement="left" onclick="finishTask()"
						...
						<button class="btn btn-white btn-sm" data-toggle="tooltip" data-placement="left" onclick="dcff()" title="调出"><i
						        class="fa fa-pencil-square-o"></i> ${label==null?'调出':label}</button>
						</button>
            ...
            <table id="contentTable" class="table table-striped table-bordered table-hover table-condensed dataTables-example dataTable">
                ...
                <c:forEach items="${page.list}" var="relation">
                    ...
                    <tr>
                        ...
                        <td>	<c:if test="${task.type == '13'}">健康养老示范项目 </c:if>
                              	<c:if test="${task.type != '13'}">${fns:getDictLabel(task.type, 'task_type', '')} </c:if> 
                        </td>
                        <td>
