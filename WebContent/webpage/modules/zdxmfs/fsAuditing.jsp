	...
	<script type="text/javascript">
		...
		$('#fsType').change(function(){
			...
			if(type=='1'){
				...
				$('#fsmsg-error').remove();
				$('#zdgcxmbh').attr("disabled",false);
			}else{
				$('#fsmsg').removeClass();
				$('#fsmsg').addClass('form-control required');
				$('#zdgcxmbh').attr("disabled","disabled");
			}
		});
		});
	</script>
...
<body class="hideScroll">
		...
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
		  	    <tr style="font-size:16px;font-weight:bold;font-family:微软雅黑;padding:0px 10px;"><td colspan="5" align="center">初审信息</td></tr>
		  	    <td class="width-15 active"><label class="pull-right">复审意见</label></td>
					<td colspan="4">${zdgcxm.csmsg }</td>
		  	    <tr style="font-size:16px;font-weight:bold;font-family:微软雅黑;padding:0px 10px;"><td colspan="5" align="center">复审信息</td></tr>
				<tr>
					<td class="width-15 active"><label class="pull-right">复审状况</label></td>
					<td colspan="4">
						<select id="fsType" name="fstype" class="form-control m-b" style="width:150px;">
				...
				<tr>
					<td class="width-15 active"><label class="pull-right">复审意见</label></td>
					<td colspan="4"><textarea id="fsmsg" name="fsmsg" maxlength="200" class="form-control" rows="3">${zdgcxm.fsmsg }</textarea></td>
				</tr>
				...
				<tr>
					...
					<td colspan="4"><input type="text" id="zdgcxmbh" name="zdgcxmbh" maxlength="50" class="form-control required"/></td>
				</tr>
				<tr>
