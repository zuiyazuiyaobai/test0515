...
<body class="gray-bg">
	...
	<div class="row">
	<div class="col-sm-12">
	<form:form id="searchForm" modelAttribute="cInsBusinessZdgcxm" action="${ctx}/zdxmfs/cInsBusinessZdgcxm/" method="post" class="form-inline">
	...
	<table id="contentTable" class="table table-striped table-bordered table-hover table-condensed dataTables-example dataTable">
		...
		<c:forEach items="${page.list}" var="cInsBusinessZdgcxm">
			<tr>
				...
				<td>
					<shiro:hasPermission name="zdxmcs:cs:view">
						<a href="#" onclick="openDialogView('查看重点项目初审菜单', '${ctx}/zdxmfs/cInsBusinessZdgcxm/edit?id=${cInsBusinessZdgcxm.id}','1000px', '750px')" class="btn btn-info btn-xs" ><i class="fa fa-search-plus"></i> 查看</a>
					</shiro:hasPermission>
					<shiro:hasPermission name="zdxmcs:cs:edit">
    				<a href="#" onclick="openDialog('审核重点项目初审菜单', '${ctx}/zdxmfs/cInsBusinessZdgcxm/auditing?id=${cInsBusinessZdgcxm.id}','1200px', '900px')" class="btn btn-success btn-xs" ><i class="fa fa-edit"></i>审核</a>
					</shiro:hasPermission>
				</td>
			</tr>
		</c:forEach>
