...
<head>
	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
			...
			if(type=='1'){
				$('#csmsg').removeClass();
				$('#csmsg').addClass('form-control');
				$('#csmsg-error').remove();
			}else{
				$('#csmsg').removeClass();
				$('#csmsg').addClass('form-control required');
			}
		});
		});
	</script>
...
<body class="hideScroll">
		<form:form id="inputForm" modelAttribute="zdgcxm" action="${ctx}/zdxmcs/cs/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
				...
				<tr>
					<td class="width-15 active"><label class="pull-right">初审状况</label></td>
					<td colspan="4">
						<select id="csType" name="cstype" class="form-control m-b" style="width:150px;">
				...
				<tr>
					<td class="width-15 active"><label class="pull-right">初审意见</label></td>
					<td colspan="4"><textarea id="csmsg" name="csmsg" maxlength="200" class="form-control" rows="3">${zdgcxm.csmsg }</textarea></td>
				</tr>
