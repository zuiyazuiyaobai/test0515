...
<body class="gray-bg">
<%-- <c:redirect url="${ctx}/xmjbxx/xmjbxx/cbxmShqList"></c:redirect> --%>
<%--<div class="wrapper wrapper-content">--%>
    <%--<div class="row  border-bottom white-bg dashboard-header">--%>
        <%--<div class="col-sm-12">--%>
            <!--  <blockquote class="text-info" style="font-size:14px">承办单位要严格按照重点工程“13710”工作制度要求，履职尽责，解决问题：
                 <br/>
                 （一）“1”即当天对电子台账通知的事项进行研究，作出安排部署，做到“事不过夜”。
                 <br/>
                 （二）“3”即3天内要向省重点办反馈办理情况，项目施工现场发生的阻工、扰工事件，承办单位要在3天内解除。
                 <br/>
                 （三）“7”即对有明确时间节点规定的一般性问题，原则上7天内要落实解决。
                 <br/>
                 （四）第二个“1”即对项目推进中的重大复杂问题要在1个月内落实解决，确实解决不了的，要提出书面解决问题的方案和时间节点报送省重点办。
                 <br/>
                    （五）“0”即所有事项都要跟踪到底、销号清零，件件有结果。
             </blockquote> -->
