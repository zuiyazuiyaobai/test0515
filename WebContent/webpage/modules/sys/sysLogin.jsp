			...
			<div class="main-content">
				<div class="row">
					<div class="col-sm-10 col-sm-offset-1">
						...
						<div class="center" style="margin: 100px 0 120px 0;">
							<h1>
								<br/>
								<%--<img src="${ctxStatic }/common/login/images/logo.png" style="width:600px">--%>
								<span style="color:#74B601;font-weight: bold;font-size: 45px;padding:20px 0;font-family:'黑体';color: white;">
									河南省投资项目在线管理系统</span>
								<br>
							</h1>
						</div>
						...
						<div class="login-container">
							...
							<div class="position-relative">
								<div id="login-box" class="login-box visible widget-box no-border bound">
									<div class="widget-body bound" style="opacity: 0.8;">
										<div class="widget-main bound">
											...
											<form id="loginForm" class="form-signin" action="${ctx}/login" method="post">
												<fieldset>
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															...
															<select name="username" id="username" class="form-control required">
																...
																<option value="410102-fg001">中原区发改委业务员</option>
																<option value="410100-fg001" selected>郑州市发改委</option>
																<option value="sfgwtzc">省发改委投资处</option>
																<option value="zxp">zxp</option>
																<option value="wzq">wzq</option>
															</select>
															-->
													...
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="password" id="password" name="password" value="123" class="form-control required" placeholder="密码" />
							...
							<!-- <div class="center"><h4 id="id-company-text"><font color="#A90E0E">&copy; </font></h4></div> -->
