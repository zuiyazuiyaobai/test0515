...
<body class="hideScroll">
		<form:form id="inputForm" modelAttribute="zdgcxm" action="${ctx}/zdxmyc/yc/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
				...
				<tr>
					...
					<td colspan="4"><textarea id="csmsg" name="csmsg" maxlength="200" class="form-control" rows="3" disabled="disabled">${zdgcxm.csmsg }</textarea></td>
				</tr>
