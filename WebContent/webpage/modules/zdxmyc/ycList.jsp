...
<body class="gray-bg">
	...
	<div class="row">
	<div class="col-sm-12">
	<form:form id="searchForm" modelAttribute="cInsBusinessZdgcxm" action="${ctx}/zdxmyc/yc/" method="post" class="form-inline">
	...
	<table id="contentTable" class="table table-striped table-bordered table-hover table-condensed dataTables-example dataTable">
		...
		<c:forEach items="${page.list}" var="cInsBusinessZdgcxm">
			<tr>
				...
				<td>
					<shiro:hasPermission name="zdxmyc:yc:view">
						<a href="#" onclick="openDialogView('查看重点项目初审菜单', '${ctx}/zdxmyc/yc/edit?id=${cInsBusinessZdgcxm.id}','800px', '500px')" class="btn btn-info btn-xs" ><i class="fa fa-search-plus"></i> 查看</a>
					</shiro:hasPermission>
					<shiro:hasPermission name="zdxmyc:yc:edit">
    				<a href="#" onclick="openDialog('审核重点项目初审菜单', '${ctx}/zdxmyc/yc/auditing?id=${cInsBusinessZdgcxm.id}','1200px', '900px')" class="btn btn-success btn-xs" ><i class="fa fa-edit"></i>审核</a>
					</shiro:hasPermission>
				</td>
			</tr>
		</c:forEach>
