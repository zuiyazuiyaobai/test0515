...
<!-- 	<div class="ibox-title">
    ...
    <div class="tabs-container">
         <ul class="nav nav-tabs">
             <li class="active"><a onclick="showOrhide(1)" data-toggle="tab" href="javascript:void(0)" aria-expanded="true">按地市统计</a>
             </li>
             <li class=""><a onclick="showOrhide(2)" data-toggle="tab" href="javascript:void(0)" aria-expanded="false">按产业聚集区统计</a>
             </li>
         </ul>
    </div>
         	...
         	<table id="contentTable" class="table table-striped table-bordered table-hover table-condensed dataTables-example dataTable">
				<thead>
					<tr>
						...
						<th  class="sort-column sszdgjxmsl">名称</th>
				...
				<tbody id="dishi">
					...
					<tbody id="jjq">
					<c:forEach items="${page2.list}" var="tj_sszdgjxmxx">
						<tr>
							<td> <input type="checkbox" id="${tj_sszdgjxmxx.id}" class="i-checks"></td>
							<td><a  href="#" onclick="openDialogView('查看tj_sszdgjxmxx', '${ctx}/tj_sszdgjxmxx/tj_sszdgjxmxx/form?id=${tj_sszdgjxmxx.id}','800px', '500px')">
								${tj_sszdgjxmxx.remarks}
