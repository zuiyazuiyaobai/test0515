...
<body class="hideScroll">
	<form:form id="inputForm" modelAttribute="notify" action="${ctx}/notice/notify/save?noticeType=2" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<sys:message content="${message}"/>	
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
		      <tr>
		         <td  class="width-15 active" style="width:10%">	<label class="pull-right"><font color="red">*</font>文号：</label></td>
		         <td class="width-35" style="width:90%">
					<form:input path="fileNo" htmlEscape="false" maxlength="200" class="form-control required"/>
				</td>
			  </tr>
		       <tr>	
