...
<head>
	...
	<script type="text/javascript">
		...
		function checkSb(ids){
		    if('${fns:getUserOffice().grade}' === '4'){
				top.layer.alert("尚未开通国家层级的数据报送，请纳为本级滚动计划！")
				return false;
            }
            return true;
		}
...
<body class="gray-bg">
	...
	<div class="row">
	<div class="col-sm-12">
	<form:form id="searchForm" modelAttribute="xmjbxxSearchParameter" action="${ctx}/xmjbxx/xmjbxx/tzjhDbqList" method="post" class="form-inline">
	...
	<div class="col-sm-12">
		<div class="pull-left">
			<shiro:hasPermission name="xmjbxx:xmjbxx:tzjhDbqList_sb">
				<table:operatePanel url="${ctx}/xmjbxx/xmjbxx/tzjhDbqSb" id="contentTable" nextOffices="${nextOffices}" checkFunc="checkSb"
									panelName="bswh" operateIndex="1" label="上报"></table:operatePanel>
			</shiro:hasPermission>
			<shiro:hasPermission name="xmjbxx:xmjbxx:tzjhDbqList_wxbs">
				<table:operateRow url="${ctx}/xmjbxx/xmjbxx/tzjhDbqTh" id="contentTable" operateIndex="1" label="退回"></table:operateRow>
			</shiro:hasPermission>
			<shiro:hasPermission name="xmjbxx:xmjbxx:tzjhDbqList_nwbjgdjh">
				<table:operateRow url="${ctx}/xmjbxx/xmjbxx/tzjhDbqNwbjgdjh" id="contentTable" operateIndex="2" label="纳为本级滚动计划"></table:operateRow>
			</shiro:hasPermission>
