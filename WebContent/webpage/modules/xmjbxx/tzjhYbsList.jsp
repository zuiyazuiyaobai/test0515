...
<body class="gray-bg">
	...
	<div class="row">
	<div class="col-sm-12">
	<form:form id="searchForm" modelAttribute="deptRelationSearchParameter" action="${ctx}/xmjbxx/xmjbxx/tzjhYbsList" method="post" class="form-inline">
	...
	<table id="contentTable" class="table table-striped table-bordered table-hover table-condensed dataTables-example dataTable">
		...
		<c:forEach items="${page.list}" var="deptRelation">
			...
			<tr>
				...
				<td>
				   <c:if test="${xmjbxx.remark != '12' && xmjbxx.remark != '13'}">${xmjbxx.remark}
				   </c:if>
				   <c:if test="${xmjbxx.remark == '12'}">2018年交通基础设施省补助资金项目
				   </c:if>
				   <c:if test="${xmjbxx.remark == '13'}">健康养老示范项目
				   </c:if>
				</td>
				<!-- <td></td> -->
