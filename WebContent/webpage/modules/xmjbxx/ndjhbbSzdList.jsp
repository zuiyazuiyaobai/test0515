...
<body class="gray-bg">
	...
	<div class="row">
	<div class="col-sm-12">
	<form:form id="searchForm" modelAttribute="deptRelationSearchParameter" action="${ctx}/xmjbxx/xmjbxx/ndjhbbSzdList" method="post" class="form-inline">
		...
		<div class="form-group right10">
			...
			<form:select path="remarks" class="form-control">
              ...
              <form:option value="1">2017年省重点项目</form:option>
              <form:option value="2">2018年省重点项目</form:option>
            </form:select>
		</div>
