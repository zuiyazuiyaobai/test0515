...
<body class="gray-bg">
	...
	<div class="row">
	<div class="col-sm-12">
	<form:form id="searchForm" modelAttribute="deptRelationSearchParameter" action="${ctx}/xmjbxx/xmjbxx/ndjhbbSjjList" method="post" class="form-inline">
		...
		<div class="form-group right10">
			<span class="left10">报送类别：</span>
			<form:select path="remarks" class="form-control">
              <form:option value=""></form:option>
              <form:option value="3">2017年省基建项目</form:option>
              <form:option value="4">2017年省基建项目</form:option>
            </form:select>
		</div>
