...
<body class="gray-bg">
	...
	<div class="row">
	<div class="col-sm-12">
	<form:form id="searchForm" modelAttribute="deptRelationSearchParameter" action="${ctx}/xmjbxx/xmjbxx/ndjhBsqList" method="post" class="form-inline">
	...
	<div class="col-sm-12">
		<div class="pull-left">
			...
			<table:operateRow url="${ctx}/xmjbxx/xmjbxx/ndjhBsqTh" id="contentTable" operateIndex="1" label="退回"></table:operateRow>
	...
	<table id="contentTable" class="table table-striped table-bordered table-hover table-condensed dataTables-example dataTable">
		...
		<c:forEach items="${page.list}" var="deptRelation">
			...
			<tr>
				...
				<td>${fns:getDictLabel(nrzt, 'nrzt', '')}</td>
				<td>
	...
	<div id="bgwhFormDiv" style="display:none;">
		<form id="bgwhForm" action="${ctx}/xmjbxx/xmjbxx/ndjhbsBgwh" method="post">
