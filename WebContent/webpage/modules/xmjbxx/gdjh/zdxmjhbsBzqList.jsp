	...
	<script type="text/javascript">
        ...
        function txxm() {
            top.layer.open({
                ...
                content: '${ctx}/xmjbxx/xmjbxx/selectNdzxjsjjForm' ,
                btn: ['确定', '关闭'],
            ...
            top.layer.confirm('确认要推送至待报区吗?', {icon: 3, title: '系统提示'}, function (index) {
                ...
                top.layer.open({
                    ...
                    btn1: function(index){
                        ...
                        var value = top.$("#wjbt").val();
                        if(null == value || '' == value) {
                            top.layer.alert("请选择文件文件标题！");
                            return false;
                        }
...
<body class="gray-bg">
	...
	<div class="row">
	<div class="col-sm-12">
	<form:form id="searchForm" modelAttribute="deptRelationSearchParameter" action="${ctx}/xmjbxx/xmjbxx/zdxmjhbsBzqList" method="post" class="form-inline">
		...
		<div class="form-group ibox-custom-content ibox-custom-content-hide right10">
			...
			<input type="hidden" name="xmjbxxSearchParameter.startTimeNStart" id="startTimeNStart" value="<fmt:formatDate value='${deptRelationSearchParameter.xmjbxxSearchParameter.startTimeNStart}' pattern='yyyy-MM-dd'/>">
			<input type="hidden" name="xmjbxxSearchParameter.startTimeNEnd" id="startTimeNEnd" value="<fmt:formatDate value='${deptRelationSearchParameter.xmjbxxSearchParameter.startTimeNEnd}' pattern='yyyy-MM-dd'/>">
		...
		<div class="form-group ibox-custom-content ibox-custom-content-hide right10">
			...
			<input type="hidden" name="xmjbxxSearchParameter.endTimeStart" id="endTimeStart" value="<fmt:formatDate value='${deptRelationSearchParameter.xmjbxxSearchParameter.endTimeStart}' pattern='yyyy-MM-dd'/>">
			<input type="hidden" name="xmjbxxSearchParameter.endTimeEnd" id="endTimeEnd" value="<fmt:formatDate value='${deptRelationSearchParameter.xmjbxxSearchParameter.endTimeEnd}' pattern='yyyy-MM-dd'/>">
	...
	<div class="col-sm-12">
		<div class="pull-left">
			...
			<table:delRow url="${ctx}/xmjbxx/xmjbxx/zxjsjjxmBzqDelete" id="contentTable"></table:delRow><!-- 删除按钮 -->
	...
	<table id="contentTable" class="table table-striped table-bordered table-hover table-condensed dataTables-example dataTable">
		...
		<tr>
			...
			<th >审核辅助标志01</th>
			<th >审核辅助标志02</th>
		    <th class="sort-column shfzbsthree">审核辅助标志03</th>
			<th>操作</th>
		</tr>
		</thead>
		<tbody>
	...
	<div id="selectFormDiv" style="display:none;">
		<form id="selectForm" action="${ctx}/xmjbxx/xmjbxx/pushToZxjsjjBsq" method="post">
			<input type="hidden" id="wjbt_id" name="id" value="12"/>
			<div style="margin: 30px 30px 0 30px;"><span style="font-size: 14px;">文件标题：</span></div>
			<div style="width:420px;margin:10px 0 0 30px;">
				<select id="wjbt" name="wjbt" class="form-control required">
