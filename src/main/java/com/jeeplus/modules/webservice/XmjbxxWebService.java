package com.jeeplus.modules.webservice;
 ...
 * 可用
 */
public class XmjbxxWebService {
    static int socketTimeout = 30000;// 请求超时时间
    static int connectTimeout = 30000;// 传输超时时间
    static Logger logger = Logger.getLogger(XmjbxxWebService.class);
    ...
    public static void main(String[] args) {
        String orderSoapXml = "<soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:sean=\"http://sean.com\">\n" +
                "   <soapenv:Header/>\n" +
                "   <soapenv:Body>\n" +
                "      <sean:add>\n" +
                "         <sean:x>1</sean:x>\n" +
        ...
        String postUrl = "http://localhost:8090/mathService";
