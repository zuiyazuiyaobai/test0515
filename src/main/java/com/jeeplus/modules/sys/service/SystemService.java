...
//		systemRealm.clearAllCachedAuthorizationInfo();
	...
	public static boolean printKeyLoadMessage(){
		...
		sb.append("\r\n======================================================================\r");
		sb.append("\r\n    欢迎使用 "+Global.getConfig("productName")+"  - Powered By TJ ！！！");
		sb.append("\r\n======================================================================\r\n");
	...
	public List<Menu> getMainMenu() {
		List<Menu> list = menuDao.getMainMenu();
		return list;
	}
	 ...
	 * @return
	 */
	public List<Menu> getChildrenMenu(String parentId) {
		List<Menu> list = menuDao.getChildrenMenu(parentId);
		return list;
	}
	
	/*public SingleMenu getSingleMenu(String id){
		SingleMenu sm = singleMenuDao.get(id);
		return sm;
	} */
