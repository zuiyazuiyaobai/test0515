...
//		}
	...
	public List<Map<String, Object>> treeData(@RequestParam(required=false) String extId, @RequestParam(required=false) String showIds,
		...
		for (int i=0; i<list.size(); i++){
			...
			if ((StringUtils.isBlank(extId) || (extId!=null && !extId.equals(e.getId()) && e.getParentIds().indexOf(","+extId+",")==-1))
					&& (StringUtils.isBlank(showIds) || (showIds!=null && (showIds.equals(e.getId()) || includeParents(showIds,e.getId()) || includeParents(showIds, e.getParentIds()))))
	...
	/**
	 * 判断 showIds 和 parentIds 是否有交集
     */
	private boolean includeParents(String showIds, String parentIds){
